...
# Function to transcribe speech, extract information, translate to Gujarati, and write to Excel
def transcribe_speech_to_excel():
    try:
        ...
        # Translate extracted information to Gujarati
        translated_first_name = translator.translate(first_name, src='en', dest='gu').text
        translated_last_name = translator.translate(last_name, src='en', dest='gu').text
        translated_location = translator.translate(location, src='en', dest='gu').text
        translated_placement_status = translator.translate(placement_status, src='en', dest='gu').text
